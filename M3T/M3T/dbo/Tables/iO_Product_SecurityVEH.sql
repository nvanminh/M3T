CREATE TABLE [dbo].[iO_Product_SecurityVEH] (
    ...
    CONSTRAINT [PK_iO_Product_SecurityVEH] PRIMARY KEY CLUSTERED ([RSC_ID] ASC) WITH (FILLFACTOR = 85)
);


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Primary Key.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'iO_Product_SecurityVEH', @level2type = N'COLUMN', @level2name = N'RSC_ID';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Redundant.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'iO_Product_SecurityVEH', @level2type = N'COLUMN', @level2name = N'RSC_Ownership';


GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Used to compare records in Replication process.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'iO_Product_SecurityVEH', @level2type = N'COLUMN', @level2name = N'RSC_IDLink_Version';
